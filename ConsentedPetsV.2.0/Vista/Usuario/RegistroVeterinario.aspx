<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RegistroVeterinario.aspx.cs" Inherits="ConsentedPets.Vista.Usuario.RegistroVeterinario" %>
        ...
        <div class="left">
            ...
            <div class="contact">
                <form runat="server">
                    ...
                    <asp:TextBox ID="txtEspecializacion" runat="server" placeholder="Especializacion"></asp:TextBox>
                    <asp:TextBox ID="txtExperiencia" runat="server" placeholder="Experiencia"></asp:TextBox>
                    <asp:TextBox ID="txtProfesion" runat="server" placeholder="Profesion"></asp:TextBox>
