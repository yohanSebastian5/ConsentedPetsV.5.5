                            ...
                            <div class="heading-tabs">
                                <div class="row">
                                    <div class="col-lg-6 offset-lg-3">
                                        <ul>
                                            <li><a href='#tabs-1'>
                                                <img src="assets/images/tab-icon-01.png" alt="">Breakfast</a></li>
                                            <li><a href='#tabs-2'>
                                                <img src="assets/images/tab-icon-02.png" alt="">Lunch</a></a></li>
                                            <li><a href='#tabs-3'>
                                                <img src="assets/images/tab-icon-03.png" alt="">Dinner</a></a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                                            ...
                                            <div class="row">
                                                <div class="right-list">
                                                    <div class="col-lg-12">
                                                        <div class="tab-item">
                                                            <img src="assets/images/tab-item-01.png" alt="">
                                                            <h6>Acana Grass-Fed Lamb para perros (6 kg)</h6>
                                                            <p>Tapete con textura diseñado para enseñar a los gatos a utilizar una zona específica para hacer sus necesidades.</p>
                                                            <div class="price">
                                                                <h6>$100000</h6>
                                                            </div>
                                                        </div>
