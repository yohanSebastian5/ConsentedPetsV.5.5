...
$('.firstNext').on('click', (e) => {
    ...
    $('.user-details').css('left', 'calc(15% - 175px)');
});
...
$('.secondNext').on('click', (e) => {
    ...
    $('.user-details2').css('left', 'calc(15% - 175px)');
});
...
$('.firstPrev').on('click', (e) => {
    ...
    $('.user-details').css('left', '4000px');
    $('.account-setup').css('left', 'calc(15% - 175px)');
});
//Tree step
$('.treeNext').on('click', (e) => {
    setTimeout(() => {
        $(steps[3]).find('.number').addClass('active');
    }, 1000);

    $(steps[3]).find('.line').addClass('line-active');
    $('.user-details2').css('left', '-4000px');
    $('.finish-step').css('left', 'calc(15% - 175px)');
});
...
$('.secondPrev').on('click', (e) => {
    $(steps[3]).find('.number').removeClass('active');
    $(steps[3]).find('.line').removeClass('line-active');
