        ...
        <div class="container">
            <div class="left" style="justify-content: center; align-items: center; display: flex;">
                <div class="login">
                    ...
                    <h2 style="display: flex; justify-content: center;">Tu Escuela Canina</h2>
                </div>
            </div>
            <div class="right">
                ...
                <div class="form">
                    <div class="d-flex align-content-between">
                        <asp:Image ID="Image1" src="../../imagenes/logoimg.png" runat="server" Style="border-radius: 52%; width: 200px; height: 200px;" />
                    </div>
