<%@ Page Title="" Language="C#" MasterPageFile="~/Vista/PerfilesRol/Administrador/Veterinaria/Veterinaria.Master" AutoEventWireup="true" CodeBehind="AgregarVeterinario.aspx.cs" Inherits="ConsentedPetsV._2._0.Vista.PerfilesRol.Administrador.Veterinaria.AgregarVeterinario" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentBodyAdministrador" runat="server">
    <div style="align-items: center; display: flex; justify-content: center;">
        <form runat="server">
            <h2 class="text-center color m-2">Agregar Veterinario</h2>
    ...
    <script>
        function cargardatos(buscar) {
            $.ajax({
                type: "POST",
                url: "AgregarVeterinario.aspx/cargardatos",
        ...
        function ActualizarDatos(buscar, espe, expe, prof) {
            $.ajax({
                type: "POST",
                url: "AgregarVeterinario.aspx/ActualizarDatos",
                contentType: "application/json; charset=utf-8",
                dataType: "json",
        ...
        function obtenerValorTextBox() {
            ...
            $.ajax({
                url: 'AgregarVeterinario.aspx/ProcesarValor',
                type: 'POST',
