<%@ Page Title="" Language="C#" MasterPageFile="~/Vista/PerfilesRol/Administrador/PerfilAdmin.Master" AutoEventWireup="true" CodeBehind="ListarEscuelas.aspx.cs" Inherits="ConsentedPetsV._2._0.Vista.PerfilesRol.Administrador.ListarEscuelas" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentBodyAdministrador" runat="server">
    ...
    <script>
        function listarVet(elementoA) {
            ...
            $.ajax({
                type: "POST",
                url: "ListarEscuelas.aspx/ListarV",
