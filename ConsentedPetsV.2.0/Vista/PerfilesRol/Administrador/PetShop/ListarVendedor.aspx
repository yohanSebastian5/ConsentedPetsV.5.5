<%@ Page Title="" Language="C#" MasterPageFile="~/Vista/PerfilesRol/Administrador/PetShop/PetShop.Master" AutoEventWireup="true" CodeBehind="ListarVendedor.aspx.cs" Inherits="ConsentedPetsV._2._0.Vista.PerfilesRol.Administrador.PetShop.ListarVendedor" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentBodyAdministrador" runat="server">
    ...
    <script>
        $(document).ready(function () {
            ...
            $.ajax({
                type: "POST",
                url: "ListarVendedor.aspx/mtdLista",
        ...
        function GuardarIdPersonal(elementoA) {
            $.ajax({
                type: "POST",
                url: "ListarVendedor.aspx/GuardarIdPersonal",
                contentType: "application/json; charset=utf-8",
                dataType: "json",
        ...
        function cargardatos(idProducto) {
            $.ajax({
                type: "POST",
                url: "ListarVendedor.aspx/cargardatos",
                contentType: "application/json; charset=utf-8",
                dataType: "json",
