...
{
    public partial class RegistrarEscuela : System.Web.UI.Page
    {
        ...
        protected void mtdRegistrar(object sender, EventArgs e)
        {
            ...
            ClEstablecimientoE objEstablecimientoE = objEstaL.mtdListarVet(nombreV,"Escuela");
            objEstaL.mtdUsuarioVeterinaria(int.Parse(Session["Usuario"].ToString()), objEstablecimientoE.id,"Escuela");
