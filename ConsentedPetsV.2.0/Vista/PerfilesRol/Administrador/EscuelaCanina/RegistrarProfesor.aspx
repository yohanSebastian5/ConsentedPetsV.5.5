<%@ Page Title="" Language="C#" MasterPageFile="~/Vista/PerfilesRol/Administrador/EscuelaCanina/Escuela.Master" AutoEventWireup="true" CodeBehind="RegistrarProfesor.aspx.cs" Inherits="ConsentedPetsV._2._0.Vista.PerfilesRol.Administrador.EscuelaCanina.RegistrarProfesor" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentBodyAdministrador" runat="server">
    <div style="align-items: center; display: flex; justify-content: center;">
        <form runat="server">
            <h2 class="text-center color m-2">Agregar Profesor</h2>
    ...
    <script>
        function cargardatos(buscar) {
            $.ajax({
                type: "POST",
                url: "RegistrarProfesor.aspx/cargardatos",
