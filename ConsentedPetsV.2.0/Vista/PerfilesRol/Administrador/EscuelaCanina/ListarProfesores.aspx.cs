...
namespace ConsentedPetsV._2._0.Vista.PerfilesRol.Administrador.EscuelaCanina
{
    public partial class ListarProfesores : System.Web.UI.Page
    {
        ...
        protected void btnEliminar_Click(object sender, EventArgs e)
        {
            ...
            objL.mtdEliminarUsuarioEs(idE, "Escuela");
            ClientScript.RegisterClientScriptBlock(this.GetType(), "alert", "swal('¡Actualizacion Exitosa !', 'Profesor Eliminado', 'success')", true);
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            ClientScript.RegisterClientScriptBlock(this.GetType(), "alert", "swal('¡Actualizacion Exitosa !', 'Profesor Actualizado', 'success')", true);
